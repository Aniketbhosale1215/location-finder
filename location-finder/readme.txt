...
1. Right click on project and Run As Java Application "PlaceApplication"

2. Open any browser and type below URI
	
3. Search for any location :Protocol GET: Using Foursquare Places

http://localhost:9000/Search?ll=40.7484,-73.9857&v=20190601



4. See a list of places with details: 
...
5. Option to filter by category / type / other attributes - Using Google Places
   Protocol GET: 
...
1. Copy the unzipped folder into your Eclipse workspace
...
4. Create a Run/Debug configuraiton for PlaceApplication.java

5. Right Click on Project and Debug As Java Application "PlaceApplication"